...
class HefestosORM
{
    ...
    /**
     * Recebe um array de conexão com o banco de dados e instancia o PDO.
     * @param array{
     *  driver['mysql'|'sqlite'],
     *  host: string,
     *  nome_db: string,
     ...
     *  senha: string,
     *  sqlite: string
     * } $db_config Onde driver pode ser mysql ou sqlite, host e nome_db são obrigatórios para o driver mysql e caminho para o sqlite no caso de sqlite.
     * @author brunoggdev
     */
